        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Create <small>Client</small></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="quickForm" novalidate="novalidate" action="{{route('admin.client.store')}}" method="POST">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="{{old('content-ar')}}" name="content-ar">

                        </div>
                        <div class="form-group">

                            <label for="exampleInputPassword2">Client Opinion EN</label>
                            <input class="form-control" type="text" value="{{old('content-en')}}" name="content-en">
