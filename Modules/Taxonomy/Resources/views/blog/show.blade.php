        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Update <small>Blog</small></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="quickForm" novalidate="novalidate" method="POST" action="{{route('admin.blog.update')}}">
                    @csrf
                    <input type="hidden" value="{{$blog->id}}" name="taxonomy_id">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Title AR</label>
                            <input type="text"
                                   value="{{old('title-ar',$blog->translate('ar')->title )}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   value="{{old('title-en',$blog->translate('en')->title )}}"
                        ...
                        <div class="form-group mb-0">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" name="status"
                                       {{$blog->status? 'checked':''}} class="custom-control-input"
                                       id="exampleCheck1">
