    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="quickForm" novalidate="novalidate" method="POST" action="{{route('admin.client-big.update')}}">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group  mb-1 mt-1">
                            ...
                            <img id="image-filemanager" class="mb-1 mt-1"
                                 src="{{old('primary-image',!is_null($client->primary_image)?$client->primary_image:asset('images/boxed-bg.jpg'))}}"
                                 width="100"
                                 data-toggle="modal"
