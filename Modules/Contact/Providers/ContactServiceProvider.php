...
class ContactServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton(ContactInterface::class, function ($app) {
            return new ContactRepository();
        });

        $this->app->singleton(AdminContactInterface::class, function ($app) {
            return new AdminContactRepository(new Contact);
        });
