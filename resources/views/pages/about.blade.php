@extends('layouts.app')
@section('meta')
    @include('partials.meta',['image'=>$about->primary_image,'page'=>trans('pages.about_us'),'desc'=>$about->content,'updated_time'=>$about->updated_at,'published_time'=>$about->created_at])
